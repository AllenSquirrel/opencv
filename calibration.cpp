...
int main(int argc, unsigned char* argv[])
{
	...
	VideoCapture vido_file_l("F:\\visual c++&&opencv\\source\\calibration\\text_l (2).avi");//在这里改相应的文件名
	VideoCapture vido_file_r("F:\\visual c++&&opencv\\source\\calibration\\text_r (2).avi");//在这里改相应的文件名
